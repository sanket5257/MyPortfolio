...
useGSAP(function(){
  ...
  return (
    <div className='absolute bottom-0 p-5 flex items-end justify-between left-0 w-full '>
        <div className=''>
            <h2 className='texr-sm text-white lg:text-2xl font-[anzo1]'>DESIGNER | &#10092; CODER &#10093; </h2>
            <h3 className=' text-lg lg:text-2xl font-[anzo2] text-gray-400'>SANKET CHOUGULE</h3>
