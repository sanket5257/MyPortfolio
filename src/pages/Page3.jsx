...
const Page3 = () => {
  return (
    <div className='bg-white relative flex items-center justify-center h-screen'>
        ...
        <video autoPlay loop muted className='relative  z-10 lg:h-[52vh] lg:w-[48vw] h-[30.3vh] w-[71vw] md:w-[50vw] sm:w-[60vw]  object-cover' src="https://video.wixstatic.com/video/f1c650_ec0546cb7b10485c8753983f298c6ea4/360p/mp4/file.mp4"></video>

            <div className='z-0 absolute bg-black h-0.5 w-3/5 top-[45%] '></div>
            <div className='z-0 absolute  bg-black h-0.5 w-4/5 top-[60%] '></div>
            <div className='z-0 absolute bg-black h-0.5 w-full top-[75%] '></div>
    </div>
  )
}
