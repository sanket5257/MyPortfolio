...
const Page3 = () => {
  return (
    <div className='bg-white relative flex items-center justify-center h-screen'>
        ...
        <video autoPlay loop muted playsInline className=' pointer-events-none relative  z-10 lg:h-[52vh] lg:w-[48vw] h-[30.3vh] w-[75vw] md:w-[50vw] sm:w-[60vw]  object-cover' src="https://video.wixstatic.com/video/f1c650_ec0546cb7b10485c8753983f298c6ea4/360p/mp4/file.mp4"></video>
