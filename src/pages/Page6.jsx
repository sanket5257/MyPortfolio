      ...
      <div className="h-[230vh]  lg:h-[140vh] md:h-[180vh] w-full overflow-hidden bg-black rounded-[4.9vh]">
        ...
        <div className="flex lg:justify-between flex-col h-[60vh] -top-5 lg:-top-10 lg:w-[100vw] w-[50vw] absolute left-7 lg:left-20 ">
          <div className=" w-full h-[50vh] lg:h-[60vh] lg:w-full" >
            <h1 className="absolute  xl:text-[14vw]  font-[anzo4] uppercase text-[40vw] lg:text-[20vw] text-gray-400">
              HOW
            </h1>

            <h1 className="absolute xl:top-[26vh] xl:text-[14vw] lg:top-[36vh]  top-[19vh] sm:top-[25vh] md:top-[38vh] font-[anzo4] uppercase text-[40vw] lg:text-[20vw] text-white">
              CAN
            </h1>
          </div>

          <div className="w-full h-[50vh] lg:w-[50%]  lg:*:right-44">
            <h1 className="absolute xl:text-[14vw]  lg:top-[1vh] top-[38vh] sm:top-[50vh] md:top-[77vh] font-[anzo4] uppercase text-[40vw] lg:text-[20vw] text-white">
              I HELP
            </h1>

            <h1 className="absolute  xl:top-[26vh] xl:text-[14vw]  lg:top-[36vh] top-[57vh]  sm:top-[75vh] md:top-[115vh] font-[anzo4] uppercase text-[40vw] lg:text-[20vw] text-white">
              YOU
            </h1>
          </div>
        </div>
