...
const About = () => {
  ...
  return (
    <div id="HireMe" className=" overflow-x-hidden h-screen top-8 relative bg-white p-2 ">
      <div
        id="page1-in"
        className=" shadow-xl relative  p-2 shadow-gray-700 h-full xl:w-full w-[95vw] bg-cover bg-[url(https://static.wixstatic.com/media/f1c650_1baf8f9dcad444669565ec73ee697a92~mv2.jpg/v1/fill/w_1854,h_1005,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Background%20Anzo_Studio.jpg)] rounded-3xl"
      >
      ...
      <div className="  footer absolute p-10 bottom-0 text-gray-400 xl:text-[1.3vw] ">
        ...
        <h1 className="absolute bottom-5 text-gray-400 w-full text-center">
            @2025ft.leostudio developed | designed
          </h1>
    </div>
  );
};
