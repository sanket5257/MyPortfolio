    ...
    <div id="HireMe" className=" h-screen relative bg-white p-2 ">
      ...
      >
        ...
        <div className="mid-content flex sm:justify-between sm:items-center">
          <img
            id="rotateImage"
            className="h-[18vw] sm:h-[10vh] md:h-[15vh] md:ml-[15vw]   lg:ml-[30vw] xl:h-[10vw] lg:h-[12vw] sm:ml-[18vw] ml-[15vw]"
          ...
          <div className="text-white text-center text-[3vw] sm:text-[2.8vw] md:text-[2vw] sm:mr-8 md:text-2xl ml-5">
            ...
            <h1 className="text-gray-400">+91-123456789</h1>
          </div>
        </div>
